...
import type { THotelBookingBase, TNewHotelBooking } from '@repo/db/schema/hotel-bookings'
...
export function BookingModal({ room, trigger, isOpen, plan, stay, onChangeState }: BookingModalProps) {
  ...
  const [bookingDetails, setBookingDetails] = useState<THotelBooking | null>(null)
  const {
    register,
    handleSubmit,
    watch,
  ...
  const calculateTotal = () => {
    const nights = calculateNights(watchedValues.checkInDate, watchedValues.checkOutDate)
                ...
                <CardContent>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-muted-foreground'>Max occupancy: {room?.capacity} guests</p>
                      <p className='font-semibold text-lg'>₹{plan?.price}/night</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div className='space-y-2'>
                      ...
                      <Popover open={checkInCalendarOpen} onOpenChange={setCheckInCalendarOpen} modal={true}>
                    ...
                    <div className='space-y-2'>
                      ...
                      <Popover open={checkOutCalendarOpen} onOpenChange={setCheckOutCalendarOpen} modal={true}>
                        <PopoverTrigger asChild>
                          <Button
                            variant='outline'
                            className={cn(
                        ...
                        <PopoverContent className='w-auto p-0 z-[60]' align='start' side='bottom' sideOffset={4}>
                          <Calendar
                            ...
                            disabled={date =>
                              date < new Date() || (watchedValues.checkInDate && date <= watchedValues.checkInDate)
                            }
                            initialFocus
                          />
                        </PopoverContent>
                    ...
                    <div className='space-y-2'>
                      ...
                      <Select
                        ...
                        onValueChange={value => setValue('numberOfRooms', parseInt(value))}>
                        <SelectTrigger>
                      ...
                      {errors.numberOfRooms && <p className='text-sm text-red-500'>{errors.numberOfRooms.message}</p>}
                    </div>
                  </div>
                  <div className='grid grid-cols-1 md:grid-cols-3 gap-4 pt-4'>
                    <div className='space-y-2'>
                      ...
                      <Select
                        ...
                        onValueChange={value => setValue('numberOfAdults', parseInt(value))}>
                        <SelectTrigger>
                      ...
                      {errors.numberOfAdults && <p className='text-sm text-red-500'>{errors.numberOfAdults.message}</p>}
                    </div>

                    <div className='space-y-2'>
                      <Label htmlFor='numberOfChildren'>Children (5-12 yrs)</Label>
                      <Select
                        value={watchedValues.numberOfChildren?.toString()}
                        onValueChange={value => setValue('numberOfChildren', parseInt(value))}>
                        <SelectTrigger>
                      ...
                      {errors.numberOfChildren && <p className='text-sm text-red-500'>{errors.numberOfChildren.message}</p>}
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <CardContent>
                    <div className='space-y-2'>
                      ...
                      <div className='flex justify-between'>
                        ...
                        <span>{calculateNights(watchedValues.checkInDate, watchedValues.checkOutDate)}</span>
                      </div>
                      <div className='flex justify-between'>
        ...
        {bookingDetails && (
          <DialogContent className='sm:max-w-md'>
            <DialogHeader className='text-center'>
              ...
              <DialogTitle className='text-xl text-center font-semibold text-green-600'>Booking Confirmed!</DialogTitle>
            </DialogHeader>
            <div className='text-center space-y-4'>
              <p className='text-muted-foreground'>
                Your booking request has been successfully submitted. We will contact you shortly to confirm the details.
              </p>
              ...
              <div className='bg-gray-50 p-4 rounded-lg space-y-2 text-sm'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span>
                    ...
                    {bookingDetails.no_of_kids > 0 && `, ${bookingDetails.no_of_kids} Children`}
                  </span>
                </div>
                <div className='flex justify-between'>
              ...
              <p className='text-xs text-muted-foreground'>An executive will contact you shortly to confirm the details.</p>
