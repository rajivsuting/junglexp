...
import { updateNaturalistBookingStatus } from '@repo/actions/naturalist-bookings.actions';
...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
  ...
  const confirmStatusUpdate = async () => {
    ...
    setLoading(true);
    try {
      await updateNaturalistBookingStatus(data.id, selectedStatus);
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => router.push(`/naturalist-bookings/${data.id}`)}
          >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to change the naturalist booking status for{" "}
