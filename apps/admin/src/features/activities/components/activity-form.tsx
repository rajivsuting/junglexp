...
import { updateActivityAmenities, updateActivityPolicies } from '@repo/actions/activities.actions'
...
export default function ActivityForm({
  ...
  const toggleSection = (section: keyof typeof sectionsExpanded | (keyof typeof sectionsExpanded)[]) => {
    ...
    <div className='mx-auto w-full space-y-6'>
      ...
      <div className='space-y-6'>
        ...
        <CollapsibleSection
          ...
          showNext={mode === 'edit' && getNextSection('activityDetails') !== null}
        ...
        {mode === 'edit' && (
          <>
            ...
            <CollapsibleSection
              ...
              <ActivityImagesSection activityId={activityId!.toString()} initialData={initialData} />
            </CollapsibleSection>
            ...
            <CollapsibleSection
              ...
              <ActivityInclusionsSection
                ...
                initialData={initialData}
                onSave={async data => {
                  await updateActivityPolicies(Number(activityId!), 'include', data.selectedPolicies)
                }}
              />
            </CollapsibleSection>
            ...
            <CollapsibleSection
              ...
              <ActivityExclusionsSection
                ...
                initialData={initialData}
                onSave={async data => {
                  await updateActivityPolicies(Number(activityId!), 'exclude', data.selectedPolicies)
                }}
              />
            </CollapsibleSection>
            ...
            <CollapsibleSection
              ...
              <ActivityItinerarySection initialData={initialData} activityId={activityId!} />
            </CollapsibleSection>
            ...
            <CollapsibleSection
              ...
              <ActivityPackagesSection activityId={activityId!} initialData={initialData} />
            </CollapsibleSection>
          </>
        )}
      </div>
